...
process_dataset("./data/data_json/train_data_info.json", "./data_pth/train_data_info.pth")

print(f'Process the validate dataset\n')
process_dataset("./data/data_json/validate_data_info.json", "./data_pth/validate_data_info.pth")

print(f'Process the test dataset\n')
process_dataset("./data/data_json/test_data_info.json", "./data_pth/test_data_info.pth")
